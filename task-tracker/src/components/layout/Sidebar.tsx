...
import { FolderOpen, LayoutGrid, Sun, Moon, LogOut, Plus, Trash2, X, Shield, ChevronRight, ChevronDown, Home } from 'lucide-react'
...
export function Sidebar({ projects, activeProjectId, activeEpicId, activeTab, onSelectProject, onSelectEpic, onSelectTab, onCreateProject, onDeleteProject, darkMode, onToggleDark }: SidebarProps) {
  ...
  function handleDashboard() {
    ...
    // Deselect project by selecting the same one (AppLayout handles null)
    if (activeProjectId) {
          ...
          <div className="px-3 py-2">
            ...
            >
              <div className={cn(
                ...
                <Shield size={14} className={activeTab === 'admin' ? 'text-indigo-500' : 'text-gray-400'} />
              </div>
